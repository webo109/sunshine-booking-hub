export const SunshineLogo = ({ className = "h-10 w-auto" }: { className?: string }) => (
  <svg viewBox="0 0 200 60" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Sun */}
    <circle cx="30" cy="25" r="10" fill="#FFD700" />
    {/* Sun rays */}
    ...
    />
    {/* Ground line */}
    <line x1="10" y1="44" x2="55" y2="44" stroke="#006400" strokeWidth="1.5" />
    {/* Text */}
    <text x="62" y="28" fontFamily="'Playfair Display', Georgia, serif" fontSize="16" fontWeight="700" fill="#006400">
      Sunshine Tours
    </text>
    <text x="62" y="42" fontFamily="'DM Sans', sans-serif" fontSize="10" fontWeight="400" fill="#006400" letterSpacing="2">
      OMAN
    </text>
  </svg>
);
